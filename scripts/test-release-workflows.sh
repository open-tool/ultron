...
assert_contains "$publish" "workflow_dispatch:"
assert_contains "$publish" "version:"
...
assert_contains "$tagger" "actions: write"
...
assert_contains "$tagger" "gh workflow run maven_central_publish\\.yml"
