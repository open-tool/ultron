...
class UltronUiObject(
    val block: () -> UiObject,
    val selectorDesc: String
) {
    fun getChild(
        uiSelector: UiSelector, timeoutMs: Long,
    ...
    fun clickAndWaitForNewWindow(
        waitWindowTimeout: Long, timeoutMs: Long,
        resultHandler: (UiAutomatorOperationResult<UiAutomatorUiSelectorOperation>) -> Unit
    ) {
        UiAutomatorLifecycle.execute(
            UiAutomatorUiSelectorOperationExecutor(
    ...
    fun perform(
        ...
        actionDescription: String, timeoutMs: Long,
        resultHandler: (UiAutomatorOperationResult<UiAutomatorUiSelectorOperation>) -> Unit
    ) {
        UiAutomatorLifecycle.execute(
            UiAutomatorUiSelectorOperationExecutor(
    ...
    fun hasText(
        textMatcher: Matcher<String>, timeoutMs: Long,
        resultHandler: (UiAutomatorOperationResult<UiAutomatorUiSelectorOperation>) -> Unit
    ) {
        UiAutomatorLifecycle.execute(
            UiAutomatorUiSelectorOperationExecutor(
    ...
    fun textContains(
        textSubstring: String, timeoutMs: Long,
        resultHandler: (UiAutomatorOperationResult<UiAutomatorUiSelectorOperation>) -> Unit
    ) {
        UiAutomatorLifecycle.execute(
            UiAutomatorUiSelectorOperationExecutor(
    ...
    fun hasContentDescription(
        contentDesc: String, timeoutMs: Long,
        resultHandler: (UiAutomatorOperationResult<UiAutomatorUiSelectorOperation>) -> Unit
    ) {
        UiAutomatorLifecycle.execute(
            UiAutomatorUiSelectorOperationExecutor(
    ...
    fun hasContentDescription(
        contentDescMatcher: Matcher<String>, timeoutMs: Long,
        resultHandler: (UiAutomatorOperationResult<UiAutomatorUiSelectorOperation>) -> Unit
    ) {
        UiAutomatorLifecycle.execute(
            UiAutomatorUiSelectorOperationExecutor(
    ...
    fun contentDescriptionContains(
        contentDescSubstring: String, timeoutMs: Long,
        resultHandler: (UiAutomatorOperationResult<UiAutomatorUiSelectorOperation>) -> Unit
    ) {
        UiAutomatorLifecycle.execute(
            UiAutomatorUiSelectorOperationExecutor(
    ...
    fun assertThat(
        ...
        assertionDescription: String, timeoutMs: Long,
        resultHandler: (UiAutomatorOperationResult<UiAutomatorUiSelectorOperation>) -> Unit
    ) {
        UiAutomatorLifecycle.execute(
            UiAutomatorUiSelectorOperationExecutor(
